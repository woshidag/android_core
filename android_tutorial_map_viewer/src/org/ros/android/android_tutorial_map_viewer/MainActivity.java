...
//  private RobotLayer robotLayer = null;
  private PoseSubscriberLayer robotLayer = null;
  private MapAnnotationLayer annotationLayer = null;
...
//    cameraView.setMessageToBitmapCallable(new BitmapFromCompressedImage());
    ...
    saveAnnoButton = (Button) findViewById(R.id.add_annotation);
    ...
    saveAnnoButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
          geometry_msgs.PoseStamped poseStamped = robotLayer.getPoseStamped();
          annotationLayer.addAnnotation(poseStamped);
//        Transform pose;
//        annotationLayer.addAnnotation(pose);
      }
    });
...
//            nodeConfiguration.setNodeName("android/camera_view"));
    ...
    annotationsPub.setMasterNameSpace(appNameSpace);
    ...
    String robotFrame  = remaps.get(getString(R.string.robot_frame));
//    String robotFrame = (String) params.get("robot_frame", getString(R.string.robot_frame));
    ...
    robotLayer = new PoseSubscriberLayer(robotFrame);
